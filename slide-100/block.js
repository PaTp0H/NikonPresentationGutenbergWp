...
const slideAttributes = {
  ...
  slideSubTitle: {
    ...
    default: 'Instant adaptation, natural to use',
    source: 'html',
	},
	items: {
		type: 'array',
		...
		default: [
			{
				title: '',
				image: imgSrc('wide/wd-adaptation-01.png'),
				navTitle: 'CONVENTIONAL LENS',
				useImage: false,
			},
			{
				title: 'IMMEDIATE COMFORT AND EASY ADAPTATION',
				image: imgSrc('wide/wd-adaptation-02.png'),
				useImage: true,
				navImage: imgSrc('wide/icon-wide.svg'),
			},
		],
		query: {
			title: {
...
registerBlockType('presentation/slide100', {
	title: __('Slide: 100', 'np'),
	icon: icon,
        ...
        <span className="white">
          ...
          />
			...
			<div className="screen_body_wrapper start bottom bottom--mod no_relative">
				<div className="wd-sharper wd-sharper--adaptation">
      ...
      {(attributes.slideTitle || attributes.slideSubTitle) &&
        <div className="brand_wrapper">
          ...
          <span className="white opacity_animate">
			...
			<div className="screen_body_wrapper start bottom bottom--mod no_relative">
				<div className="wd-sharper wd-sharper--adaptation opacity_animate">
					<div className="wd-sharper__board js-tab-wrap">
