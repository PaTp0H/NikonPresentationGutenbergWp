...
const slideAttributes = {
	...
	imageUrl1: {
		...
		default: imgSrc("relaxsee/relaxsee-img.png")
	},
	imageUrl2: {
		attribute: 'src',
		selector: '.title-screen__icon img',
		default: imgSrc("relaxsee/icon-relaxsee.svg")
	},
	screenName: {
		type: 'string',
		selector: '.title-screen__name',
		source: 'html',
		default: 'Eye Strain<br>Relief For All Ages'
	},
	flipped: {
		type: 'boolean',
		default: false
...
registerBlockType('presentation/slide86', {
	title: __('Slide: #86', 'np'),
	icon: icon,
