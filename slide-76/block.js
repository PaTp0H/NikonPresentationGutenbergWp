...
const slideAttributes = {
	...
	imageUrl1: {
		...
		default: imgSrc("blue-uv/blue-uv-img.png")
	},
	imageUrl2: {
		attribute: 'src',
		selector: '.title-screen__icon img',
		default: imgSrc("plus-uv/icon-plus-uv.svg")
	},
	screenName: {
		type: 'string',
		selector: '.title-screen__name',
		source: 'html',
		default: 'See Life<br>At Its Best'
	},
	flipped: {
		type: 'boolean',
		default: false
...
registerBlockType('presentation/slide76', {
	title: __('Slide: #76', 'np'),
	icon: icon,
