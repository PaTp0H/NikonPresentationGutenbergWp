...
const slideAttributes = {
  ...
  slideSubTitle: {
    ...
    default: 'Wider, clearer and sharper vision across the entire lens',
    source: 'html',
	},
	items: {
		type: 'array',
		...
		default: [
			{
				title: '',
				image: imgSrc('wide/wd-sharper-01.png'),
				navTitle: 'CONVENTIONAL LENS',
				useImage: false,
			},
			{
				title: 'SHARPER VISION',
				image: imgSrc('wide/wd-sharper-02.png'),
				useImage: true,
...
registerBlockType('presentation/slide99', {
	title: __('Slide: 99', 'np'),
	icon: icon,
      ...
      {(attributes.slideTitle || attributes.slideSubTitle) &&
        <div className="brand_wrapper">
          ...
          <span className="white opacity_animate">
			...
			<div className="screen_body_wrapper start bottom bottom--mod no_relative">
				<div className="wd-sharper opacity_animate">
					<div className="wd-sharper__board js-tab-wrap">
