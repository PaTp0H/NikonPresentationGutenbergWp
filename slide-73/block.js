...
const slideAttributes = {
	...
	imageUrl1: {
		...
		default: imgSrc("bright/bright-img.png")
	},
	imageUrl2: {
		attribute: 'src',
		selector: '.title-screen__icon img',
		default: imgSrc("bright/icon-bright.svg")
	},
	screenName: {
		type: 'string',
		selector: '.title-screen__name',
		source: 'html',
		default: 'Brighten Your Vision<br>Even In Dim <br> Light Condition'
	},
	flipped: {
		type: 'boolean',
		default: false
...
registerBlockType('presentation/slide73', {
	title: __('Slide: #73', 'np'),
	icon: icon,
