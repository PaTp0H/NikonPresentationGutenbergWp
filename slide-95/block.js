...
const slideAttributes = {
	...
	imageUrl1: {
		...
		default: imgSrc("advance/advance-img.png")
	},
	imageUrl2: {
		attribute: 'src',
		selector: '.title-screen__icon img',
		default: imgSrc("advance/icon-advance.svg")
	},
	screenName: {
		type: 'string',
		selector: '.title-screen__name',
		source: 'html',
		default: 'Digitally<br>Optimised Vision'
	},
	flipped: {
		type: 'boolean',
		default: false
...
registerBlockType('presentation/slide95', {
	title: __('Slide: #95', 'np'),
	icon: icon,
