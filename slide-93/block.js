...
const slideAttributes = {
	...
	imageUrl1: {
		...
		default: imgSrc("wide/wide-img.jpg")
	},
	imageUrl2: {
		attribute: 'src',
		selector: '.title-screen__icon img',
		default: imgSrc("wide/icon-wide.svg")
	},
	screenName: {
		type: 'string',
		selector: '.title-screen__name',
		source: 'html',
		default: 'Absolute Precision,<br>Wide Angle Vision'
	},
	flipped: {
		type: 'boolean',
		default: false
...
registerBlockType('presentation/slide93', {
	title: __('Slide: #93', 'np'),
	icon: icon,
