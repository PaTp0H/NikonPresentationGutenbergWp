...
const slideAttributes = {
	...
	imageUrl1: {
		...
		default: imgSrc("ultimate/seemax-img.jpg")
	},
	imageUrl2: {
		attribute: 'src',
		selector: '.title-screen__icon img',
		default: imgSrc("master/icon-master.svg")
	},
	screenName: {
		type: 'string',
		selector: '.brand_wrapper .white',
		default: 'Digitaly Enhanced For Stress Free Vision'
	},
	flipped: {
		type: 'boolean',
		default: false
...
registerBlockType('presentation/slide90', {
	title: __('Slide: #90', 'np'),
	icon: icon,
