...
registerBlockType('presentation/slide107', {
	title: __('Slide: #107 Benefits (4 items)', 'np'),
	icon: icon,
	...
	attributes: {
		...
		cardWhiteTitle_top: {
			...
			source: 'html',
			default: '<span style="color: #c09800" class="artb-font-color">ADAPTABILITY</span>',
		},
		cardDescription_top: {
			type: 'string',
			selector: '.card_top .descr',
			source: 'html',
			default: 'By offering the most up-to-date products, you can respond quickly to trends and cater to new, ever-changing consumer habits.',
		},
		...
		cardWhiteTitle_bottom: {
			...
			source: 'html',
			default: '<span style="font-size: 29px" class="artb-font-size">OFFER THE MOST</span><br><span style="color: #c09800" class="artb-font-color">OUTSTANDING<br>PERFORMANCE</span>',
		},
		cardDescription_bottom: {
			type: 'string',
			selector: '.card_bottom .descr',
			source: 'html',
			default: 'When you sell Nikon, you are offering the best-performing products on the market and thus satisfying your customers’ visual requirements.',
		},
		...
		cardWhiteTitle_left: {
			...
			source: 'html',
			default: '<span style="font-size: 29px" class="artb-font-size">CHANGE</span><br><span style="color: #c09800" class="artb-font-color">CONSUMER<br>PERCEPTION</span>',
		},
		cardDescription_left: {
			type: 'string',
			selector: '.card_left .descr',
			source: 'html',
			default: 'Offering innovation reduces the perceived banality of a product by improving its attributes and benefits.',
		},
		...
		cardWhiteTitle_right: {
			...
			source: 'html',
			default: '<span style="font-size: 29px" class="artb-font-size">EASIER TO RECOMMEND</span><br><span style="color: #c09800" class="artb-font-color">AND UPGRADE</span>',
		},
		cardDescription_right: {
			type: 'string',
			selector: '.card_right .descr',
			source: 'html',
			default: 'Upselling is easier as the Nikon catalog consists of simple, yet, complete range of products that meet today\'s demanding lifestyle and wearers.',
		},


		imageUrl1: {
			default: imgSrc('bg/bg-vision@2x.jpg')
		}
	}
