		...
		default: [
			{
				...
				tabTitle: '',
				number: '5',
				text: `<span style="color: #c09800" class="artb-font-color"><span style="font-size: 150px" class="artb-font-size"><span class="np-style-font-weight-bold"><span class="np-style-stroke-accent-bold">benefits</span></span></span></span><br><span style="font-size: 56px" class="artb-font-size"><span style="color: #fff" class="artb-font-color"><span class="np-style-font-weight-bold">of SeeCoat Blue UV</span></span></span><br><span class="np-style-font-weight-bold"><span style="color: #fff" class="artb-font-color"><span style="font-size: 50px" class="artb-font-size">to reducing blue light</span></span></span><span style="color: #fff" class="artb-font-color"><span style="font-size: 56px" class="artb-font-size"><p class="np-style-align-left"></p></span></span>`,
			},
			{
				tabType: 'clickable',
				mainImage: imgSrc('blue-uv/buv-benefits-01.png'),
				icon: imgSrc('blue-uv/icon-blue-uv.svg'),
				tabTitle: 'BETTER CONTRAST',
				tabImage: imgSrc('blue-uv/buv-benefits-icon-01.svg'),
				text: `2 times more scratch resistant<br>Longer lens durability`,
				info: `Conventional AR Coating`,
				items: [],
				subtitle: 'Better Contrast ',
				listItems: [
					<li>Blue light cut</li>,
					<li>Optimized transparency</li>,
					<li>Enhances the contrast by reducing <br/>unwanted blue light</li>,
				],
...
registerBlockType('presentation/slide114', {
	title: __('Slide: 114', 'np'),
	icon: icon,
	...
	(({activeTab, setState, className, attributes, setAttributes}) => {
		...
		const insight = i => {
			if ('inner' === attributes.insights[i].tabType)
				return <div className="ult-insights__inner js-main-content ult-insights__inner--infinite" data-for-content={i}>
			...
			return <div
				className={"ult-insights__holder ult-insights__info " + (1 === i ? 'ult-insights__info--buv ' : 'ult-insights__info--buv')}
				data-for-content={i}>
		...
		return <div className={className + " block-presentation-slide all-empty"}
			...
			<div className="screen_body_wrapper bottom bottom--mod no_relative">
				<div className="ult-insights js-tile-wrap" data-tab-content={activeTab}>
					<div className="ult-insights__content ult-insights__content--drive">
			...
			return <div className="insight-item">
				<div className="tab-type" data-tab-type={attributes.insights[i].tabType}>
					...
					{'inner' === attributes.insights[i].tabType && (
						<div className=" ult-insights__inner js-main-content ult-insights__inner--infinite" data-for-content={i}>
							<div className="ult-insights__inner-info">
